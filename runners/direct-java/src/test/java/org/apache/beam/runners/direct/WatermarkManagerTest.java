...
public class WatermarkManagerTest implements Serializable {
  ...
  public void getSynchronizedProcessingTimeOutputHeldToPendingTimers() {
    ...
    Map<AppliedPTransform<?, ?, ?>, Map<StructuralKey<?>, KeyedWorkItem<?, ?>>> firedTimers =
  ...
  public void extractFiredTimersReturnsFiredEventTimeTimers() {
    Map<AppliedPTransform<?, ?, ?>, Map<StructuralKey<?>, KeyedWorkItem<?, ?>>> initialTimers =
        manager.extractFiredTimers();
    ...
    Map<AppliedPTransform<?, ?, ?>, Map<StructuralKey<?>, KeyedWorkItem<?, ?>>>
    ...
    Map<StructuralKey<?>, KeyedWorkItem<?, ?>> secondFilteredTimers =
    ...
    KeyedWorkItem<?, ?> secondFired = secondFilteredTimers.get(key);
