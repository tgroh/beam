...
public interface DirectOptions extends PipelineOptions, ApplicationNameOptions {
  ...
  @JsonIgnore
  @Hidden
  TransformEvaluatorRegistry.Factory getTransformEvaluatorRegistryFactory();

  void setTransformEvaluatorRegistryFactory(TransformEvaluatorRegistry.Factory registry);
