...
abstract class CommittedResult<
    ExecutableT, CollectionT, BundleT extends Bundle<?, ? extends CollectionT>> {
  /**
   ...
   */
  public abstract Optional<? extends BundleT> getUnprocessedInputs();

  /**
   * Returns the outputs produced by the transform.
   */
  public abstract Iterable<? extends BundleT> getOutputs();
  ...
  public static CommittedResult<AppliedPTransform<?, ?, ?>, PCollection<?>, CommittedBundle<?>>
      create(
