...
public class GrpcLoggingService extends BeamFnLoggingGrpc.BeamFnLoggingImplBase
   ...
   *
   * <p>Maintains the set of connected clients. Mutually hangs up on clients that have errored
   * or completed.
   */
