...
public abstract class GroupAlsoByWindowsDoFn<K, InputT, OutputT, W extends BoundedWindow>
  ...
  protected final Counter droppedDueToClosedWindow =
      Metrics.counter(GroupAlsoByWindowsDoFn.class, DROPPED_DUE_TO_CLOSED_WINDOW_COUNTER);
  protected final Counter droppedDueToLateness =
      Metrics.counter(GroupAlsoByWindowsDoFn.class, DROPPED_DUE_TO_LATENESS_COUNTER);
}
