...
public class InProcessPipelineRunner
  ...
  @SuppressWarnings("rawtypes")
  private static Map<Class<? extends PTransform>, TransformEvaluatorFactory>
  ...
  public InProcessPipelineResult run(Pipeline pipeline) {
    ...
    InProcessEvaluationContext context =
        InProcessEvaluationContext.create(this, visitor.getRootTransforms(),
            visitor.getValueToConsumers(), visitor.getStepNames(), visitor.getViews());
  ...
  /**
   * Gets the transform evaluator factory for the provided {@link PTransform} class, or {@code null}
   * if no such evaluator exists.
   */
  public TransformEvaluatorFactory getTransformEvaluatorFactory(Class<? extends PTransform> clazz) {
    return defaultEvaluatorFactories.get(clazz);
  }
}
