...
class InProcessEvaluationContext {
  ...
  private final InProcessPipelineRunner runner;
  ...
  public static InProcessEvaluationContext create(InProcessPipelineRunner runner,
    ...
    return new InProcessEvaluationContext(
        runner, rootTransforms, valueToConsumers, stepNames, views);
  }

  private InProcessEvaluationContext(InProcessPipelineRunner runner,
      Collection<AppliedPTransform<?, ?, ?>> rootTransforms,
      Map<PValue, Collection<AppliedPTransform<?, ?, ?>>> valueToConsumers,
      Map<AppliedPTransform<?, ?, ?>, String> stepNames, Collection<PCollectionView<?>> views) {
  ...
  public InProcessPipelineOptions getPipelineOptions() {
    return runner.getPipelineOptions();
  }
  ...
  public InProcessExecutionContext getExecutionContext(
    ...
    return new InProcessExecutionContext(runner.getPipelineOptions().getClock(), key,
  ...
  public <T> TransformEvaluator<T> getTransformEvaluator(
    ...
    return runner.getTransformEvaluatorFactory(transform.getTransform().getClass())
        .forApplication(transform, inputBundle, this);
  }
