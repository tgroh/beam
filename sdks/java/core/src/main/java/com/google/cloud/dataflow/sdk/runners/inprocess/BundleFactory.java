...
public interface BundleFactory {
  /**
   * Create a {@link UncommittedBundle} from an empty input. Elements added to the bundle belong to
   * the provided {@link PCollection}.
   */
  public <T> UncommittedBundle<T> createRootBundle(PCollection<T> output);

  /**
   * Create a {@link UncommittedBundle} from the specified input. Elements added to the bundle
   * belong to the specified {@link PCollection}.
   */
