...
public interface POutput {
   ...
   *
   * <p>For a compound {@code POutput}, it is advised to call this method on each component {@code
   * POutput}.
   *
   ...
   *
   * <p>This method will be called once for each {@link PTransform} application that outputs this
   * {@link POutput}, either directly or within the expansion of a composite {@link POutput}.
   */
  void finishSpecifyingOutput(String producerName, PInput input, PTransform<?, ?> transform);
}
