 ...
 */
public abstract class IterableLikeCoderBase<T, IterableT extends Iterable<T>>
    extends CustomCoder<IterableT> {
  ...
  protected IterableLikeCoderBase(Coder<T> elementCoder, String  iterableName) {
    checkArgument(elementCoder != null, "element Coder for IterableLikeCoderBase must not be null");
    checkArgument(iterableName != null, "iterable name for IterableLikeCoderBase must not be null");
  ...
  public void verifyDeterministic() throws NonDeterministicException {
    throw new NonDeterministicException(this,
        "IterableLikeCoderBase can not guarantee deterministic ordering.");
  }
