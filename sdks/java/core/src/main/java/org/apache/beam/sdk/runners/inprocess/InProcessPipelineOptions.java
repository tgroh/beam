...
public interface InProcessPipelineOptions extends PipelineOptions, ApplicationNameOptions {
   ...
   *
   * <p>Defaults to a {@link WorkStealingPoolExecutorServiceFactory}, which produces instances of
   * {@link Executors#newCachedThreadPool()}.
   */
  @JsonIgnore
  @Required
  @Hidden
  @Default.InstanceFactory(WorkStealingPoolExecutorServiceFactory.class)
