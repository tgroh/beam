...
public abstract class Sink<T> implements Serializable, HasDisplayData {
  ...
  /**
   * Returns a coder suitable for encoding the result of outputs of the
   * {@link WriteOperation Write Operations} produced by
   * {@link #createWriteOperation(PipelineOptions)}.
   */
