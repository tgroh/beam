...
import org.apache.beam.sdk.util.AccumulateAllPanes;
...
/**
 * Tests for {@link AccumulateAllPanes}.
 */
@RunWith(JUnit4.class)
public class AccumulateAllPanesTest implements Serializable {
  @Test
  public void singlePaneSingleReifiedPane() {
    ...
    PCollection<Iterable<WindowedValue<Iterable<Long>>>> accumulatedPanes =
        p.apply(CountingInput.upTo(20000))
            ...
            .apply(new AccumulateAllPanes<Iterable<Long>>());
