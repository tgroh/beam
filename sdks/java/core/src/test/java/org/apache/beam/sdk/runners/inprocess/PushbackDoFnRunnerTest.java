...
/**
 * Tests for {@link PushbackDoFnRunner}.
 */
@RunWith(JUnit4.class)
public class PushbackDoFnRunnerTest {
  ...
  public void processElementSideInputNotReady() {
    ...
    PushbackDoFnRunner<Integer, Integer> runner =
        new PushbackDoFnRunner<>(
  ...
  public void processElementNoSideInputs() {
    PushbackDoFnRunner<Integer, Integer> runner =
        new PushbackDoFnRunner<>(underlying, ImmutableList.<PCollectionView<?>>of(), reader);
