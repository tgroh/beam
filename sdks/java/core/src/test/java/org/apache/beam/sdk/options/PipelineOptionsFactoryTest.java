...
public class PipelineOptionsFactoryTest {
  ...
  public void testAutomaticRegistrationOfRunners() {
    assertEquals(
        ...
        PipelineOptionsFactory.getRegisteredRunners()
                              .get(OptionsExampleRunner.class.getSimpleName()));
  }
  ...
  public void testSettingUnknownRunner() {
    ...
    assertThat(registeredRunners, hasItem(OptionsExampleRunner.class.getSimpleName()));
  ...
  public void testEmptyArgumentIsIgnored() {
    String[] args =
        new String[] {
          "", "--string=100", "", "", "--runner=" + OptionsExampleRunner.class.getSimpleName()
        };
    PipelineOptionsFactory.fromArgs(args).as(Objects.class);
  }
  ...
  public void testNullArgumentIsIgnored() {
    String[] args =
        new String[] {
          "--string=100", null, null, "--runner=" + OptionsExampleRunner.class.getSimpleName()
        };
    PipelineOptionsFactory.fromArgs(args).as(Objects.class);
  }
  ...
  /**
   * An example {@link PipelineRunnerRegistrar} to demonstrate {@link PipelineRunner} registration.
   */
