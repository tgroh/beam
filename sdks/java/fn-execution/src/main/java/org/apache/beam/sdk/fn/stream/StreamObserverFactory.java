...
public abstract class StreamObserverFactory {
   ...
   */
  public static StreamObserverFactory createBuffered(ExecutorService executorService) {
   ...
   * buffer size.
   */
  public static StreamObserverFactory createBuffered(
   ...
   */
  public static StreamObserverFactory createDefault() {
    return new Direct();
  }
